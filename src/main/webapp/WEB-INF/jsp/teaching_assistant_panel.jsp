...
<head>
    ...
    <link rel="stylesheet" href="/css/teaching_assistant_panel.css">
    <link rel="stylesheet" href="/assets/css/bootstrap.min.css">
    <title>Teaching Assistant Panel</title>
</head>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="teachingAssistantPanel/viewCourses">ViewCourses<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
